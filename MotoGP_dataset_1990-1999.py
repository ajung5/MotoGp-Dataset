...
def assign_finish_positions(
    ...
    2. Jika kosong, gunakan urutan klasifikasi API

    DNF/NC tetap numerik apabila berada dalam
    ...
    # --------------------------------------------------------
    # PASS 2
    # Fallback berdasarkan urutan classification
    # --------------------------------------------------------
...
def main():
    ...
    print()
    print("=" * 80)
    print("MOTOGP / 500CC HISTORICAL SCRAPER")
    print("=" * 80)
